...
module.exports = {
	...
	get_suspense:function(req, res){
		var user = req.getUser()
		var page = req.query.page || 1;
		var moviesSearchUrl ="http://api.themoviedb.org/3/genre/10748/movies?api_key=" + process.env.moviedata + "&page=" + page;
		request(moviesSearchUrl, function(error, response, body){
			var info = JSON.parse(body);
			var data = info.results.map(function(data){
				return data;
			});
			res.render("suspense", {data:data, page:page, user:user})
		})
	},
